...
reset_itc <- function() {
    invisible(.Call('_cause_reset_itc', PACKAGE = 'cause'))
}

set_parallel <- function(parallel = FALSE) {
    .Call('_cause_set_parallel', PACKAGE = 'cause', parallel)
}

get_parallel <- function() {
    .Call('_cause_get_parallel', PACKAGE = 'cause')
}
